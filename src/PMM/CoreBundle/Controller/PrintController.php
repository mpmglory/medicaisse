...
class PrintController extends Controller
{
    ...
    public function commandeAction($id, Request $request){
        ...
        if( null !== $commande->getMedoc1()->getQuantity()  ){
            // libelle
            $pdf->SetXY( 7, $y+9 ); $pdf->Cell( 140, 5, $commande->getMedoc1()->getMedicament()->getName(), 0, 0, 'L');
            // qte
            $pdf->SetXY( 145, $y+9 ); $pdf->Cell( 13, 5, $commande->getMedoc1()->getQuantity(), 0, 0, 'R');
            // PU
        ...
        if( null !== $commande->getMedoc2()->getQuantity()  ){
            // libelle
            $pdf->SetXY( 7, $y+9 ); $pdf->Cell( 140, 5, $commande->getMedoc2()->getMedicament()->getName(), 0, 0, 'L');
            // qte
            $pdf->SetXY( 145, $y+9 ); $pdf->Cell( 13, 5, $commande->getMedoc2()->getQuantity(), 0, 0, 'R');
            // PU
        ...
        if( null !== $commande->getMedoc3()->getQuantity()  ){
            // libelle
            $pdf->SetXY( 7, $y+9 ); $pdf->Cell( 140, 5, $commande->getMedoc3()->getMedicament()->getName(), 0, 0, 'L');
            // qte
            $pdf->SetXY( 145, $y+9 ); $pdf->Cell( 13, 5, $commande->getMedoc3()->getQuantity(), 0, 0, 'R');
            // PU
        ...
        if( null !== $commande->getMedoc4()->getQuantity()  ){
            // libelle
            $pdf->SetXY( 7, $y+9 ); $pdf->Cell( 140, 5, $commande->getMedoc4()->getMedicament()->getName(), 0, 0, 'L');
            // qte
            $pdf->SetXY( 145, $y+9 ); $pdf->Cell( 13, 5, $commande->getMedoc4()->getQuantity(), 0, 0, 'R');
            // PU
        ...
        if( null !== $commande->getMedoc5()->getQuantity()  ){
            // libelle
            $pdf->SetXY( 7, $y+9 ); $pdf->Cell( 140, 5, $commande->getMedoc5()->getMedicament()->getName(), 0, 0, 'L');
            // qte
            $pdf->SetXY( 145, $y+9 ); $pdf->Cell( 13, 5, $commande->getMedoc5()->getQuantity(), 0, 0, 'R');
            // PU
        ...
        if( null !== $commande->getMedoc6()->getQuantity()  ){
            // libelle
            $pdf->SetXY( 7, $y+9 ); $pdf->Cell( 140, 5, $commande->getMedoc6()->getMedicament()->getName(), 0, 0, 'L');
            // qte
            $pdf->SetXY( 145, $y+9 ); $pdf->Cell( 13, 5, $commande->getMedoc6()->getQuantity(), 0, 0, 'R');
            // PU
        ...
        if( null !== $commande->getMedoc7()->getQuantity()  ){
            // libelle
            $pdf->SetXY( 7, $y+9 ); $pdf->Cell( 140, 5, $commande->getMedoc7()->getMedicament()->getName(), 0, 0, 'L');
            // qte
            $pdf->SetXY( 145, $y+9 ); $pdf->Cell( 13, 5, $commande->getMedoc7()->getQuantity(), 0, 0, 'R');
            // PU
        ...
        if( null !== $commande->getMedoc8()->getQuantity()  ){
            // libelle
            $pdf->SetXY( 7, $y+9 ); $pdf->Cell( 140, 5, $commande->getMedoc8()->getMedicament()->getName(), 0, 0, 'L');
            // qte
            $pdf->SetXY( 145, $y+9 ); $pdf->Cell( 13, 5, $commande->getMedoc8()->getQuantity(), 0, 0, 'R');
            // PU
        ...
        if( null !== $commande->getMedoc9()->getQuantity()  ){
            // libelle
            $pdf->SetXY( 7, $y+9 ); $pdf->Cell( 140, 5, $commande->getMedoc9()->getMedicament()->getName(), 0, 0, 'L');
            // qte
            $pdf->SetXY( 145, $y+9 ); $pdf->Cell( 13, 5, $commande->getMedoc9()->getQuantity(), 0, 0, 'R');
            // PU
        ...
        if( null !== $commande->getMedoc10()->getQuantity()  ){
            // libelle
            $pdf->SetXY( 7, $y+9 ); $pdf->Cell( 140, 5, $commande->getMedoc10()->getMedicament()->getName(), 0, 0, 'L');
            // qte
            $pdf->SetXY( 145, $y+9 ); $pdf->Cell( 13, 5, $commande->getMedoc10()->getQuantity(), 0, 0, 'R');
            // PU
        ...
        if( null !== $commande->getMedoc11()->getQuantity()  ){
            // libelle
            $pdf->SetXY( 7, $y+9 ); $pdf->Cell( 140, 5, $commande->getMedoc11()->getMedicament()->getName(), 0, 0, 'L');
            // qte
            $pdf->SetXY( 145, $y+9 ); $pdf->Cell( 13, 5, $commande->getMedoc11()->getQuantity(), 0, 0, 'R');
            // PU
        ...
        if( null !== $commande->getMedoc12()->getQuantity()  ){
            // libelle
            $pdf->SetXY( 7, $y+9 ); $pdf->Cell( 140, 5, $commande->getMedoc12()->getMedicament()->getName(), 0, 0, 'L');
            // qte
            $pdf->SetXY( 145, $y+9 ); $pdf->Cell( 13, 5, $commande->getMedoc12()->getQuantity(), 0, 0, 'R');
            // PU
        ...
        if( null !== $commande->getMedoc13()->getQuantity()  ){
            // libelle
            $pdf->SetXY( 7, $y+9 ); $pdf->Cell( 140, 5, $commande->getMedoc13()->getMedicament()->getName(), 0, 0, 'L');
            // qte
            $pdf->SetXY( 145, $y+9 ); $pdf->Cell( 13, 5, $commande->getMedoc13()->getQuantity(), 0, 0, 'R');
            // PU
        ...
        if( null !== $commande->getMedoc14()->getQuantity()  ){
            // libelle
            $pdf->SetXY( 7, $y+9 ); $pdf->Cell( 140, 5, $commande->getMedoc14()->getMedicament()->getName(), 0, 0, 'L');
            // qte
            $pdf->SetXY( 145, $y+9 ); $pdf->Cell( 13, 5, $commande->getMedoc14()->getQuantity(), 0, 0, 'R');
            // PU
        ...
        if( null !== $commande->getMedoc15()->getQuantity()  ){
            // libelle
            $pdf->SetXY( 7, $y+9 ); $pdf->Cell( 140, 5, $commande->getMedoc15()->getMedicament()->getName(), 0, 0, 'L');
            // qte
            $pdf->SetXY( 145, $y+9 ); $pdf->Cell( 13, 5, $commande->getMedoc15()->getQuantity(), 0, 0, 'R');
            // PU
