 ...
 * Medoc8
 *
 * @ORM\Table(name="medoc8")
 * @ORM\Entity(repositoryClass="PMM\CoreBundle\Repository\Medoc8Repository")
 */
class Medoc8
{
        
    /**
     * @ORM\ManyToOne(targetEntity="PMM\CoreBundle\Entity\Medicament", inversedBy="medoc8")
     */
    private $medicament;
