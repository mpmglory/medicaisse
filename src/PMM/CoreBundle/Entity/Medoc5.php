 ...
 * Medoc5
 *
 * @ORM\Table(name="medoc5")
 * @ORM\Entity(repositoryClass="PMM\CoreBundle\Repository\Medoc5Repository")
 */
class Medoc5
{
        
    /**
     * @ORM\ManyToOne(targetEntity="PMM\CoreBundle\Entity\Medicament", inversedBy="medoc5")
     */
    private $medicament;
