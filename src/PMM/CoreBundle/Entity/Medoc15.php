 ...
 * Medoc15
 *
 * @ORM\Table(name="medoc15")
 * @ORM\Entity(repositoryClass="PMM\CoreBundle\Repository\Medoc15Repository")
 */
class Medoc15
{
        
    /**
     * @ORM\ManyToOne(targetEntity="PMM\CoreBundle\Entity\Medicament", inversedBy="medoc15")
     */
    private $medicament;
