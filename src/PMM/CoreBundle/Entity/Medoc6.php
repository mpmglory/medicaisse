 ...
 * Medoc6
 *
 * @ORM\Table(name="medoc6")
 * @ORM\Entity(repositoryClass="PMM\CoreBundle\Repository\Medoc6Repository")
 */
class Medoc6
{
        
    /**
     * @ORM\ManyToOne(targetEntity="PMM\CoreBundle\Entity\Medicament", inversedBy="medoc6")
     */
    private $medicament;
