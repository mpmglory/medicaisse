 ...
 * Medoc10
 *
 * @ORM\Table(name="medoc10")
 * @ORM\Entity(repositoryClass="PMM\CoreBundle\Repository\Medoc10Repository")
 */
class Medoc10
{
        
    /**
     * @ORM\ManyToOne(targetEntity="PMM\CoreBundle\Entity\Medicament", inversedBy="medoc10")
     */
    private $medicament;
