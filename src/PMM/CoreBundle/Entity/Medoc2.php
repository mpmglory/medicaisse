 ...
 * Medoc2
 *
 * @ORM\Table(name="medoc2")
 * @ORM\Entity(repositoryClass="PMM\CoreBundle\Repository\Medoc2Repository")
 */
class Medoc2
{
    
    /**
     * @ORM\ManyToOne(targetEntity="PMM\CoreBundle\Entity\Medicament", inversedBy="medoc2")
     */
    private $medicament;
