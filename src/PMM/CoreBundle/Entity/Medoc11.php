 ...
 * Medoc11
 *
 * @ORM\Table(name="medoc11")
 * @ORM\Entity(repositoryClass="PMM\CoreBundle\Repository\Medoc11Repository")
 */
class Medoc11
{
        
    /**
     * @ORM\ManyToOne(targetEntity="PMM\CoreBundle\Entity\Medicament", inversedBy="medoc11")
     */
    private $medicament;
