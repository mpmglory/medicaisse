 ...
 * Medoc4
 *
 * @ORM\Table(name="medoc4")
 * @ORM\Entity(repositoryClass="PMM\CoreBundle\Repository\Medoc4Repository")
 */
class Medoc4
{
        
    /**
     * @ORM\ManyToOne(targetEntity="PMM\CoreBundle\Entity\Medicament", inversedBy="medoc4")
     */
    private $medicament;
