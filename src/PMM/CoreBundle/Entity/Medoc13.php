 ...
 * Medoc13
 *
 * @ORM\Table(name="medoc13")
 * @ORM\Entity(repositoryClass="PMM\CoreBundle\Repository\Medoc13Repository")
 */
class Medoc13
{
        
    /**
     * @ORM\ManyToOne(targetEntity="PMM\CoreBundle\Entity\Medicament", inversedBy="medoc13")
     */
    private $medicament;
