 ...
 * Medoc14
 *
 * @ORM\Table(name="medoc14")
 * @ORM\Entity(repositoryClass="PMM\CoreBundle\Repository\Medoc14Repository")
 */
class Medoc14
{
        
    /**
     * @ORM\ManyToOne(targetEntity="PMM\CoreBundle\Entity\Medicament", inversedBy="medoc14")
     */
    private $medicament;
