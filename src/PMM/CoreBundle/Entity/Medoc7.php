 ...
 * Medoc7
 *
 * @ORM\Table(name="medoc7")
 * @ORM\Entity(repositoryClass="PMM\CoreBundle\Repository\Medoc7Repository")
 */
class Medoc7
{
        
    /**
     * @ORM\ManyToOne(targetEntity="PMM\CoreBundle\Entity\Medicament", inversedBy="medoc7")
     */
    private $medicament;
