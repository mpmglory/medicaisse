 ...
 * Caisse1
 *
 * @ORM\Table(name="caisse1")
 * @ORM\Entity(repositoryClass="PMM\LaboBundle\Repository\Caisse1Repository")
 */
class Caisse1
{
    
    /**
     * @ORM\OneToOne(targetEntity="PMM\LaboBundle\Entity\Bulletin", mappedBy="caisse1")
